...
int main(int ac, char *av[])
{
    ...
    SimpleDynamics<fluid_dynamics::InflowTurbulentCondition> impose_turbulent_inflow_condition(left_emitter, characteristic_length,
                                                                                               relaxation_rate_turbulent_inlet,
                                                                                               type_turbulent_inlet, initial_turbu_values);
