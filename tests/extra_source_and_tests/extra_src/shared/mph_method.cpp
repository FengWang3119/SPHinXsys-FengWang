...
void CalculateVolumeStrain<Inner<>>::interaction(size_t index_i, Real dt)
{
    ...
    for (size_t n = 0; n != inner_neighborhood.current_size_; ++n)
    {
        ...
        if (index_i != index_j)
        {
            ...
            //     {
            //         std::cout << "--------------------------------" << std::endl;
            //         std::cout << "index_i=" << index_i << ", the number of inner neighbour particles is: " << inner_neighborhood.current_size_ << std::endl;
            //     }
            //     std::cout << "index_i=" << index_i << ", index_j=" << index_j << ", rij= " << inner_neighborhood.r_ij_[n] << std::endl;
            // }
            // if (index_i == 720)
            // {
            //     if (n == 0)
...
void CalculateVolumeStrain<Contact<>>::interaction(size_t index_i, Real dt)
{
    ...
    for (size_t k = 0; k < DataDelegateContact::contact_configuration_.size(); ++k)
    {
        ...
        for (size_t n = 0; n != contact_neighborhood.current_size_; ++n)
        {
            ...
            //     {
            //         std::cout << "--------------------------------" << std::endl;
            //         std::cout << "index_i=" << index_i << ", the number of wall neighbour particles is: " << contact_neighborhood.current_size_ << std::endl;
            //     }
            //     std::cout << "index_i=" << index_i << ", index_j=" << index_j << ", rij= " << contact_neighborhood.r_ij_[n]
            //               << ", Wij= " << contact_neighborhood.W_ij_[n] << std::endl;
            // }
            // if (index_i == 720)
            // {
            //     if (n == 0)
