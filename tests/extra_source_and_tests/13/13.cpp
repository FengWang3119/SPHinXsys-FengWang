...
int main(int ac, char *av[])
{
    ...
    InteractionWithUpdate<fluid_dynamics::kEpsilon_GetVelocityGradientInner> get_velocity_gradient(water_block_inner, weight_vel_grad_sub_nearwall);
    ...
    InteractionWithUpdate<fluid_dynamics::kEpsilon_kTransportEquationInner> k_equation_relaxation(water_block_inner, initial_turbu_values, is_AMRD, is_source_term_linearisation);
    InteractionWithUpdate<fluid_dynamics::kEpsilon_epsilonTransportEquationInner> epsilon_equation_relaxation(water_block_inner, is_source_term_linearisation);
    ...
    InteractionDynamics<fluid_dynamics::kEpsilon_StandardWallFunctionCorrection> standard_wall_function_correction(water_block_inner, water_wall_contact, y_p_constant);
    ...
    // Right/Outlet buffer
    //----------------------------------------------------------------------
    AlignedBox right_emitter_shape(xAxis, Transform(Rotation2d(outlet_emitter_rotation_angel), Vec2d(right_buffer_translation)), right_buffer_halfsize);
    ...
    SimpleDynamics<fluid_dynamics::kEpsilon_TurbulentEddyViscosity> update_eddy_viscosity(water_block);
    //----------------------------------------------------------------------
